...
> 
> 本项目为武汉大学测绘学院 位置实践与服务 期末大作业。实现了从真实物理世界视频采集，到三维场景重建，再到“开放词汇(Open-Vocabulary)”自然语言交互的端到端全栈落地，并成功突破限制，部署于纯静态 Web 端。
...
- **[📺 YouTube 项目展示视频 (Demo Video)](https://youtu.be/K092dP0SfVg)** —— *完整功能演示与效果对比。*
